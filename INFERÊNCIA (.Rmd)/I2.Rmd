...
*Sim. É possivel afirmar que a média da tensão de ruptura dos cabos aumentou, com 99% de chance, em todos os 
intervalos considerados,para todas as amostras, pois a hipótese nula, a qual considera que a média é igual
a 1800 kg, falhou em aceitar e, $z_{0}$ > $z_{\alpha}$*
