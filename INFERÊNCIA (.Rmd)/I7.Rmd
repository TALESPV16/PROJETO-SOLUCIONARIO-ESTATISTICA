...
O intervalo de confiança permite deduzir que 92% dos intervalos de confiança gerados por amostragens aleatórias iram conter a média verdadeira o número de vasilhames nas casas do perímetro municipal.

###Resposta letra b)
Utilizou-se a distribuição z como estatística de teste, para o cálculo do tamanho da mostra admitindo um erro de 0,1. A equação para a definição do tamanho da amostra com erro especificado para a média de uma distribuição normal com variância conhecida é exposta no código abaixo:
