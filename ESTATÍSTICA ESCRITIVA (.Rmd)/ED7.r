## QUESTÃO ED7
Uma determinada empresa química faz uso de água superficial e de poços no seu processo produtivo, o qual 
inclui a operação de três plantas (figura 1). Um indicador do consumo de água (ICA) foi construído 
considerando a relação entre captação total de água (ou consumo de água) e produção total. 
